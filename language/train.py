...
from interventions.aipr import aipr
...
method_type = 'vanilla' # vanilla, full_reset, snp, aipr
wandb_log = True
comment = ""
...
if method_type == 'aipr':
    wandb_run_name += str(aipr_iteration)
...
if method_type not in ("vanilla", "full_reset", "snp", "aipr"):
...
if len(warm_start_load_path) > 0:
    ...
    elif method_type == 'aipr':
        aipr(model, iteration=aipr_iteration)
else:
